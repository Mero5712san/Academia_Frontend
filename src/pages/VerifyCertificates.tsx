...
export default function VerifyCertificates() {
    ...
    let pathColor = "red";
    if (confidence >= 75) pathColor = "green";
    else if (confidence >= 50) pathColor = "orange";
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <Dialog open={openModal} onClose={() => setOpenModal(false)} className="relative z-50">
                    ...
                    <div className="fixed inset-0 flex items-center justify-center p-4">
                        <DialogPanel className="bg-white rounded-xl shadow-lg max-w-3xl w-full p-6 relative">
